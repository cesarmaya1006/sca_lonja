...
class EmpleadoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('intranet.parametros.empleados.index', compact('regionales', 'user'));
    }
    ...
    public function create()
    {
        ...
        return view('intranet.parametros.empleados.crear', compact('regionales', 'tiposdocu',));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('intranet.parametros.empleados.editar', compact('regionales','empleado_edit','tiposdocu'));
    }
