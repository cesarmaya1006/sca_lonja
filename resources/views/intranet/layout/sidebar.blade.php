<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-image: url('{{ asset('imagenes/sistema/bogota.jpg') }}');background-repeat: no-repeat;">
    <!-- Brand Logo -->
    <a href="{{ route('dashboard') }}" class="brand-link bg-light" style="text-decoration: none;background-color: rgba(39, 39, 39, 0.8);">
        <img src="{{ asset('imagenes/sistema/logo_sca.png') }}" alt="M & M" class="brand-image img-circle elevation-3" style="opacity: .8;max-height: 10px;" >
