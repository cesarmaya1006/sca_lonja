...
@section('titulo_card')
    Listado de Empleados por regionales
@endsection
...
@section('cuerpoPagina')
    ...
    <div class="row">
        <div class="col-12 col-md-3 form-group" id="caja_empresas">
            ...
            <select class="form-control form-control-sm" data_url="{{ route('empleado.getEmpleadosRegional') }}"
                id="region_id">
    ...
    <div class="row d-flex justify-content-md-center">
        ...
        <input type="hidden" id="cargos_edit" data_url="{{ route('empleado.edit', ['id' => 1]) }}">
        <input type="hidden" id="cargos_destroy" data_url="{{ route('empleado.destroy', ['id' => 1]) }}">
        @csrf @method('delete')
