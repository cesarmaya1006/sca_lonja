...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('municipio.index') }}">Regionales</a></li>
...
@section('cuerpoPagina')
    <div class="row d-flex justify-content-center">
        <form class="col-12 col-md-6 form-horizontal" action="{{ route('regional.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
            @csrf
            @method('post')
